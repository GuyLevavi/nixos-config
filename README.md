...
home/
  base.nix                   # headless config — shell, git, CLI tools
...
Dockerfile.headless          # Ubuntu + Nix + home-manager using #airgap output (online)
...
| `Super+F`             | Fullscreen                        |
| `Super+Shift+L`       | Lock screen (DMS lock)            |
| `Print`               | Screenshot region → clipboard     |
| `Super+Print`         | Screenshot fullscreen → clipboard |
| `Super+H/J/K/L`       | Move focus (vim-style)            |
| `Super+Shift+H/J/K/L` | Move window                       |
| `Super+Alt+H/J/K/L`   | Resize window                     |
| `Super+Tab`           | Next workspace (wraps)            |
| `Super+Shift+Tab`     | Previous workspace (wraps)        |
| `Alt+Tab`             | Next window                       |
